...
import { PWAElementCategory, PWAItemsSecurityEntry, PWAItemsSecurityRights, PWASecurityEntry} from '../models/models';


export class ElementCategoryControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWAElementCategory> {
		...
		return this.http.get<PWAElementCategory>(localVarPath, 
		{
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAElementCategory> {
		const localVarPath = this.basePath + '/elementcategories/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public update(webId: string, elementCategory: PWAElementCategory) : Observable<any> {
		const localVarPath = this.basePath + '/elementcategories/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
		...
		return this.http.patch<any>(localVarPath, elementCategory, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
