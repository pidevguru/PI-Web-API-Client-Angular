...
export class AnalysisCategoryControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWAAnalysisCategory> {
		...
		return this.http.get<PWAAnalysisCategory>(localVarPath, 
		{
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAAnalysisCategory> {
		const localVarPath = this.basePath + '/analysiscategories/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public update(webId: string, category: PWAAnalysisCategory) : Observable<any> {
		const localVarPath = this.basePath + '/analysiscategories/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
		...
		return this.http.patch<any>(localVarPath, category, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
