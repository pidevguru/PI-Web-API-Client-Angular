...
import { PWAAnalysisRulePlugIn} from '../models/models';


export class AnalysisRulePlugInControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWAAnalysisRulePlugIn> {
		...
		return this.http.get<PWAAnalysisRulePlugIn>(localVarPath, 
		{
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAAnalysisRulePlugIn> {
