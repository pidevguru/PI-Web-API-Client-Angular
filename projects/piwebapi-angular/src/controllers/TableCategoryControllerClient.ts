...
import { PWAItemsSecurityEntry, PWAItemsSecurityRights, PWASecurityEntry, PWATableCategory} from '../models/models';


export class TableCategoryControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWATableCategory> {
		...
		return this.http.get<PWATableCategory>(localVarPath, 
		{
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWATableCategory> {
		const localVarPath = this.basePath + '/tablecategories/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public update(webId: string, tableCategory: PWATableCategory) : Observable<any> {
		const localVarPath = this.basePath + '/tablecategories/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
		...
		return this.http.patch<any>(localVarPath, tableCategory, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
