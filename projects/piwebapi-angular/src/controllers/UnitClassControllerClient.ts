...
import { PWAUnit, PWAUnitClass} from '../models/models';


export class UnitClassControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWAUnitClass> {
		...
		return this.http.get<PWAUnitClass>(localVarPath, 
		{
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAUnitClass> {
		const localVarPath = this.basePath + '/unitclasses/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public update(webId: string, unitClassDTO: PWAUnitClass) : Observable<any> {
		const localVarPath = this.basePath + '/unitclasses/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
		...
		return this.http.patch<any>(localVarPath, unitClassDTO, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
	...
	public getCanonicalUnit(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAUnit> {
	...
	public getUnits(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAUnit> {
	...
	public createUnit(webId: string, unitDTO: PWAUnit, webIdType?: string) : Observable<any> {
		const localVarPath = this.basePath + '/unitclasses/{webId}/units'
			.replace('{' + 'webId' + '}', String(webId));
		...
		return this.http.post<any>(localVarPath, unitDTO, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
