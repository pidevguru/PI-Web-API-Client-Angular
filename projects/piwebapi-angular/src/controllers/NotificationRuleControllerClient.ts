...
import { PWAItemsNotificationRule, PWAItemsNotificationRuleSubscriber, PWAItemsSecurityEntry, PWAItemsSecurityRights, PWANotificationRule, PWANotificationRuleSubscriber, PWASecurityEntry} from '../models/models';


export class NotificationRuleControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWANotificationRule> {
		const localVarPath = this.basePath + '/notificationrules';
		...
		return this.http.get<PWANotificationRule>(localVarPath, 
		{
	...
	public getNotificationRulesQuery(databaseWebId?: string, maxCount?: number, query?: string, selectedFields?: string, startIndex?: number, webIdType?: string) : Observable<PWAItemsNotificationRule> {
		const localVarPath = this.basePath + '/notificationrules/search';
	...
	public delete(webId: string) : Observable<any> {
		const localVarPath = this.basePath + '/notificationrules/{webId}'
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWANotificationRule> {
		const localVarPath = this.basePath + '/notificationrules/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public update(webId: string, notificationRule: PWANotificationRule) : Observable<any> {
		const localVarPath = this.basePath + '/notificationrules/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
		...
		let headers = this.defaultHeaders;
			...
			throw new Error('Required parameter notificationRule was null or undefined when calling update.');
		}

		return this.http.patch<any>(localVarPath, notificationRule, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
	...
	public getNotificationRuleSubscribers(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAItemsNotificationRuleSubscriber> {
		const localVarPath = this.basePath + '/notificationrules/{webId}/notificationrulesubscribers'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public createNotificationRuleSubscriber(webId: string, notificationRuleSubscriber: PWANotificationRuleSubscriber, webIdType?: string) : Observable<any> {
		const localVarPath = this.basePath + '/notificationrules/{webId}/notificationrulesubscribers'
			.replace('{' + 'webId' + '}', String(webId));
		...
		let headers = this.defaultHeaders;
			...
			if (webId === null || webId === undefined) {
			throw new Error('Required parameter webId was null or undefined when calling createNotificationRuleSubscriber.');
		}

			if (notificationRuleSubscriber === null || notificationRuleSubscriber === undefined) {
			throw new Error('Required parameter notificationRuleSubscriber was null or undefined when calling createNotificationRuleSubscriber.');
		}
	...
	public getSecurity(webId: string, userIdentity: Array<string>, forceRefresh?: boolean, selectedFields?: string, webIdType?: string) : Observable<PWAItemsSecurityRights> {
		const localVarPath = this.basePath + '/notificationrules/{webId}/security'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public getSecurityEntries(webId: string, nameFilter?: string, selectedFields?: string, webIdType?: string) : Observable<PWAItemsSecurityEntry> {
		const localVarPath = this.basePath + '/notificationrules/{webId}/securityentries'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public deleteSecurityEntry(name: string, webId: string, applyToChildren?: boolean) : Observable<any> {
		const localVarPath = this.basePath + '/notificationrules/{webId}/securityentries/{name}'
