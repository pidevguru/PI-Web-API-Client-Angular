...
import { PWAAttributeTemplate, PWAElementTemplate, PWAItemsAnalysisTemplate, PWAItemsAttributeTemplate, PWAItemsElementCategory, PWAItemsElementTemplate, PWAItemsNotificationRuleTemplate, PWAItemsSecurityEntry, PWAItemsSecurityRights, PWANotificationRuleTemplate, PWASecurityEntry} from '../models/models';


export class ElementTemplateControllerClient {
	...
	public getByPath(path: string, selectedFields?: string, webIdType?: string) : Observable<PWAElementTemplate> {
		...
		return this.http.get<PWAElementTemplate>(localVarPath, 
		{
	...
	public get(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAElementTemplate> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public update(webId: string, template: PWAElementTemplate) : Observable<any> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public getAnalysisTemplates(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAItemsAnalysisTemplate> {
	...
	public getAttributeTemplates(webId: string, depthFirstTraverse?: boolean, maxCount?: number, selectedFields?: string, showDescendants?: boolean, showInherited?: boolean, startIndex?: number, webIdType?: string) : Observable<PWAItemsAttributeTemplate> {
		...
		if ((depthFirstTraverse !== undefined) && (depthFirstTraverse !== null)) {
			queryParameters = queryParameters.set('depthFirstTraverse', <any>depthFirstTraverse);
		}
		...
		if ((showDescendants !== undefined) && (showDescendants !== null)) {
			queryParameters = queryParameters.set('showDescendants', <any>showDescendants);
		}

		if ((showInherited !== undefined) && (showInherited !== null)) {
			queryParameters = queryParameters.set('showInherited', <any>showInherited);
		}
		...
		return this.http.get<PWAItemsAttributeTemplate>(localVarPath, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
	...
	public createAttributeTemplate(webId: string, template: PWAAttributeTemplate, webIdType?: string) : Observable<any> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}/attributetemplates'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public getBaseElementTemplates(webId: string, maxCount?: number, selectedFields?: string, webIdType?: string) : Observable<PWAItemsElementTemplate> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}/baseelementtemplates'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public getCategories(webId: string, selectedFields?: string, showInherited?: boolean, webIdType?: string) : Observable<PWAItemsElementCategory> {
	...
	public getDerivedElementTemplates(webId: string, maxCount?: number, selectedFields?: string, showDescendants?: boolean, webIdType?: string) : Observable<PWAItemsElementTemplate> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}/derivedelementtemplates'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public getNotificationRuleTemplates(webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAItemsNotificationRuleTemplate> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}/notificationruletemplates'
			.replace('{' + 'webId' + '}', String(webId));
	...
	public createNotificationRuleTemplate(webId: string, notificationRuleTemplate: PWANotificationRuleTemplate, webIdType?: string) : Observable<any> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}/notificationruletemplates'
			.replace('{' + 'webId' + '}', String(webId));
		...
		let headers = this.defaultHeaders;
			...
			if (webId === null || webId === undefined) {
			throw new Error('Required parameter webId was null or undefined when calling createNotificationRuleTemplate.');
		}

			if (notificationRuleTemplate === null || notificationRuleTemplate === undefined) {
			throw new Error('Required parameter notificationRuleTemplate was null or undefined when calling createNotificationRuleTemplate.');
		}
		...
		return this.http.post<any>(localVarPath, notificationRuleTemplate, 
		{
			params: queryParameters,
			withCredentials: this.withCredentials,
			headers: headers,
	...
	public getSecurityEntryByName(name: string, webId: string, selectedFields?: string, webIdType?: string) : Observable<PWAItemsSecurityEntry> {
		const localVarPath = this.basePath + '/elementtemplates/{webId}/securityentries/{name}'
			.replace('{' + 'name' + '}', String(name))
			.replace('{' + 'webId' + '}', String(webId));
