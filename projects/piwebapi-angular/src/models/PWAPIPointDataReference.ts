export class PWAPIPointDataReference {
	...
	public WebId?: string;
	public Zero?: number;
	constructor(descriptor?: string, digitalSetName?: string, displayDigits?: number, engineeringUnits?: string, future?: boolean, id?: number, name?: string, path?: string, pointClass?: string, pointType?: string, span?: number, step?: boolean, webId?: string, zero?: number) {
		if (descriptor!=null) {
