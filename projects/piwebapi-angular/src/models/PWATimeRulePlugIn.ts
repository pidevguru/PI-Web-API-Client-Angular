import { PWATimeRulePlugInLinks, PWAWebException } from './models';

export class PWATimeRulePlugIn {
	...
	public Links?: PWATimeRulePlugInLinks;
	...
	public WebId?: string;
	constructor(assemblyFileName?: string, assemblyID?: string, assemblyLoadProperties?: Array<string>, assemblyTime?: string, compatibilityVersion?: number, description?: string, id?: string, isBrowsable?: boolean, isNonEditableConfig?: boolean, links?: PWATimeRulePlugInLinks, loadedAssemblyTime?: string, loadedVersion?: string, name?: string, path?: string, version?: string, webException?: PWAWebException, webId?: string) {
