...
export class PWANotificationRule {
	...
	public WebId?: string;
	constructor(autoCreated?: boolean, categoryNames?: Array<string>, criteria?: string, description?: string, id?: string, multiTriggerEventOption?: string, name?: string, nonrepetitionInterval?: string, path?: string, resendInterval?: string, status?: string, templateName?: string, webException?: PWAWebException, webId?: string) {
		if (autoCreated!=null) {
