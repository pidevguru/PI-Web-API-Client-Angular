import { PWADeliveryChannelPlugInLinks, PWAWebException } from './models';

export class PWANotificationPlugIn {
	...
	public Links?: PWADeliveryChannelPlugInLinks;
	...
	public WebId?: string;
	constructor(assemblyFileName?: string, assemblyID?: string, assemblyLoadProperties?: Array<string>, assemblyTime?: string, compatibilityVersion?: number, description?: string, id?: string, isBrowsable?: boolean, isNonEditableConfig?: boolean, links?: PWADeliveryChannelPlugInLinks, loadedAssemblyTime?: string, loadedVersion?: string, name?: string, path?: string, version?: string, webException?: PWAWebException, webId?: string) {
